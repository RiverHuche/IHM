...
public class AppliSomme extends Application {
    ...
    public void additionne(){
       try{
            Double res2 = Double.parseDouble(this.tf1.getText()) + Double.parseDouble(this.tf2.getText());
            String res3 = res2 + "";
            this.resultat.setText(res3);
       }catch(NumberFormatException nb ){
        System.out.println("L'entrée ne correspond au type qui est attendu dans le champ");
       }
    }
}
